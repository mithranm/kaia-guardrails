...
from kaia_guardrails.hooks.implementation.focus_process_manager import FocusProcessManager
...
class TestFocusProcessManager:
    ...
    def test_focus_stack_data_structure(self, manager):
        ...
        required_fields = [
            "focus_id", "description", "started_at",
            "parent_focus", "escape_hatch_available"
        ]
