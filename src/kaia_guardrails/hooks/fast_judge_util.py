...
Respond with just "yes" or "no" in JSON format: {{"answer": "yes"}} or {{"answer": "no"}}"""
    ...
    try:
            ...
            if "choices" in result and len(result["choices"]) > 0:
                ...
                if content:
                    try:
                        ...
                        return {"answer": answer_str == "yes", "success": True}
        ...
        return {"answer": False, "success": False, "error": "No response from LLM"}

    except Exception as e:
        return {"answer": False, "success": False, "error": f"LLM call failed: {e}"}
